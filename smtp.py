...
def smtp_send(password, message_info, message_text):
    ...
    print(read_line(wrapped_socket))
    wrapped_socket.send(base64.b64encode(password.encode()))
    wrapped_socket.send(b'\r\n')
    print(read_line(wrapped_socket))
    wrapped_socket.send(base64.b64encode(b'MAIL FROM:<' + message_info['From'].encode() + b'>\r\n'))
    print(read_line(wrapped_socket))
    wrapped_socket.send(base64.b64encode(b'RCPT TO:<' + message_info['To'].encode() + b'>')+b'\r\n')
    print(read_line(wrapped_socket))
    wrapped_socket.send(base64.b64encode(b'DATA')+b'\r\n')
    print(read_line(wrapped_socket))
    wrapped_socket.send(base64.b64encode(b'From: ' + message_info['From'].encode())+b'\r\n')
    print(read_line(wrapped_socket))
    wrapped_socket.send(base64.b64encode(b'To: ' + message_info['To'].encode())+b'\r\n')
    print(read_line(wrapped_socket))
    wrapped_socket.send(base64.b64encode(b'Date: ' + message_info['Date'].encode())+b'\r\n')
    print(read_line(wrapped_socket))
    wrapped_socket.send(base64.b64encode(b'Subject: ' + message_info['Subject'].encode())+b'\r\n')
    print(read_line(wrapped_socket))
    wrapped_socket.send(b'\r\n')
    wrapped_socket.send(base64.encode(message_text))
    wrapped_socket.send(b'\r\n')
